...
val GemIcon: ImageVector = ImageVector.Builder(
    defaultWidth = 72.dp,
    defaultHeight = 72.dp,
    viewportWidth = 72f,
    viewportHeight = 72f
).apply {
    // Todas las rutas del SVG convertidas a ImageVector
    path(fill = SolidColor(Color(0xFF0096D1))) {
        moveTo(26.1f, 49.8f)
    ...
    path(fill = SolidColor(Color(0xFF76DFFF))) {
        moveTo(71.5f, 30.5f)
    ...
    path(fill = SolidColor(Color(0xFF59CAFC))) {
        moveTo(36.3f, 71.7f)
    ...
    path(fill = SolidColor(Color(0xFF27C7FF))) {
        moveTo(26.5f, 19.7f)
        lineToRelative(-9.2f, 10f)
    ...
    path(fill = SolidColor(Color(0xFFB0E9FF))) {
        moveTo(45.4f, 19.7f)
    ...
    path(fill = SolidColor(Color(0xFF00B1FF))) {
        moveTo(26.5f, 19.7f)
        lineToRelative(-9.2f, 10f)
        horizontalLineTo(0.1f)
    ...
    path(fill = SolidColor(Color(0xFF0074A8))) {
        moveTo(23.2f, 43.1f)
        lineToRelative(-6.3f, 6.7f)
